                ...
                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="contact-btn">
                                            <button class="btn" name="btn-send" type="submit">Gửi Liên Hệ</button>
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="contact-info pt-0">
                            ...
                            <ul>
                                <li><i class="fa fa-fax"></i> Địa chỉ: 390,  Hoàng Văn Thụ,  P.9,  Q.Tân Bình, Hồ Chí Minh.</li>
                                <li><i class="fa fa-phone"></i>+84764856228 </li>
                                <li><i class="fa fa-envelope-o"> ltltstore@gmail.com</i> </li>
                            </ul>
                            <div class="working-time">
                                <h3>Thời gian làm việc</h3>
                                <p class="pb-0"><span>Thứ 2 – Thứ 7:</span>08AM – 22PM</p>
                            </div>
                        </div>
                    </div>
                </div>
