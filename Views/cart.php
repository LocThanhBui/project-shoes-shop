                                ...
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="pro-subtotal">Tổng Số Tiền</th>
                                            <th class="pro-remove">Xóa</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td class="pro-thumbnail"><a href="#"><img class="img-fluid" src="../assets/img/product/nike/AIR FORCE 1 LOW QS.jpg" alt="Product" /></a></td>
                                            <td class="pro-title"><a href="#">Sản phẩm mẫu 1</a></td>
                                        ...
                                        <tr>
                                            <td class="pro-thumbnail"><a href="#"><img class="img-fluid" src="../assets/img/product/jordan/AIR JORDAN 1 LOW BRED.png" alt="Product" /></a></td>
                                            <td class="pro-title"><a href="#">Sản phẩm mẫu 2</a></td>
                                        ...
                                        <tr>
                                            <td class="pro-thumbnail"><a href="#"><img class="img-fluid" src="../assets/img/product/adidas/ADGE GAMEDAY.jpg" alt="Product" /></a></td>
                                            <td class="pro-title"><a href="#">Sản phẩm mẫu 3</a></td>
                                            <td class="pro-price"><span>$295.00</span></td>
                                            <td class="pro-quantity">
                                                <div class="pro-qty">
                                        ...
                                        <tr>
                                            <td class="pro-thumbnail"><a href="#"><img class="img-fluid" src="../assets/img/product/nike/AIR FORCE 1 LV8 EMB.jpg" alt="Product" /></a></td>
                                            <td class="pro-title"><a href="#">Sản phẩm mẫu 4</a></td>
                    ...
                    <div class="row">
                        <div class="col-lg-5 ml-auto">
                            ...
                            <div class="cart-calculator-wrapper">
                                ...
                                <a href="#" class="btn d-block">Mua Hàng</a>
                            </div>
                        </div>
                    </div>
                </div>
